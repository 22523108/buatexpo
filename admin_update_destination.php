...
<head>
   ...
   <title>update destination | vacansheesh admin</title>
...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <input type="submit" value="update destination" name="update_product" class="btn">
   <a href="admin_destination.php" class="option-btn">go back</a>
</form>
